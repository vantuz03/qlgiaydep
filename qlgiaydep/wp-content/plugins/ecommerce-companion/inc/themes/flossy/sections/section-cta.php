<?php 
	...
	$cta_ttl		= get_theme_mod( 'cta_ttl','Free Shipping');
	$cta_subttl		= get_theme_mod( 'cta_subttl','Free Delivery Now On Your First Order and over $200');
	$cta_btn_lbl	= get_theme_mod( 'cta_btn_lbl','ONLY $200*');
