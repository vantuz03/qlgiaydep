<?php
	...
	function ecommerce_comp_flossy_lproducts() {
		...
		$latest_product_ttl 		= get_theme_mod('latest_product_ttl','Latest <span class="text-primar">Stock</span><div class="title-animation"></div>'); 
		$latest_product_subttl 		= get_theme_mod('latest_product_subttl','Free Shipping & Return');
		$latest_product_desc 		= get_theme_mod('latest_product_desc','Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa doloremque asperiores porro.');
